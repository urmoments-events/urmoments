        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.map((svc) => (
            <article key={svc.title} className="rounded-xl bg-white p-6 shadow ring-1 ring-slate-200 flex flex-col">
              ...
              <div className="mt-6">
                <a href="#contact" className="inline-flex items-center justify-center rounded-md bg-rose-600 px-4 py-2 text-white text-sm font-medium shadow hover:bg-rose-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500">Enquire</a>
              </div>
            </article>
          ))}
        </div>
